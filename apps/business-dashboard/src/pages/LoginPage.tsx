    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">RiderGuy Business</h1>
          <p className="text-gray-600 mt-2">Sign in to your business dashboard</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent outline-none transition"
          ...
          <button
            ...
            onClick={() => {
              ...
              setError('Google sign-in will be implemented with OAuth 2.0');
            }}
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <a href="http://localhost:5000/partner/individual" className="text-green-600 font-medium hover:underline">
                Sign up
              </a>
            </p>
          </div>
        ...
        <p className="text-center text-gray-600 mt-6 text-sm">
          Need help? Contact{' '}
          <a href="mailto:business@riderguy.com" className="text-green-600 hover:underline">
